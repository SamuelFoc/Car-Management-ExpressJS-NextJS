...
export default function Car({ car }) {
  return (
    <Link
      href={`/cars/${car?.id}`}
      className="bg-gray-100 hover:bg-gray-600 hover:bg-opacity-5 bg-opacity-5 rounded-md w-56 p-4 flex flex-col items-center justify-center gap-1 hover:cursor-pointer relative"
    >
